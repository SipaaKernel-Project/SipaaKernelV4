...
namespace SipaaKernel.Graphics
{
    public unsafe class Font : IDisposable
    {
        ...
        [IL2CPU.API.Attribs.ManifestResourceStream(ResourceName = "SipaaKernel.Graphics.DefaultFont.btf")] private static byte[] DFont;
        public static Font Default = new(DefaultCharset, DFont, 16);
